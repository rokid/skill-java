...
public class ActionUtil {
   ...
   * 构建Voice节点.
   *
   * @param voiceAction ResVoice.VOICE_ACTION
   * @param disableEvent 是否关闭Event事件
   * @param noWait 是否需要等待tts执行完毕以后再执行Media
   */
  public static ResVoice getResVoice(String voiceAction, boolean disableEvent, boolean noWait,
      String itemId,
      String voiceContent)
      throws ProtocolException {
